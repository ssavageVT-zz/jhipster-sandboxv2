(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('ptotrackerApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-ptotrackerApp-error');
                var entityKey = httpResponse.headers('X-ptotrackerApp-params');
                if (errorHeader) {
