(function() {
    ...
    EmployeeDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Employee', 'Department', 'Job', 'PtoPeriod', 'PtoRequest'];

    function EmployeeDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Employee, Department, Job, PtoPeriod, PtoRequest) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('ptotrackerApp:employeeUpdate', result);
